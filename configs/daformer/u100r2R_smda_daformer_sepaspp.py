...
_base_ = [
    ...
    '../_base_/datasets/smda_u100r2R_512x512.py',
...
log_interval = 5000
checkpoint_config = dict(by_epoch=False, interval=log_interval, max_keep_ckpts=10)
evaluation = dict(interval=log_interval, metric='mIoU')
# Meta Information for Result Analysis
name = 'u100r2R_smda_daformer_sepaspp_bottleneck_t_0.05_640x640'
exp = 'baseline_supervised'
