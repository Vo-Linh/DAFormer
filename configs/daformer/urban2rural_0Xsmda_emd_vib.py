...
_base_ = [
    ...
    '../_base_/datasets/smda_urban_X_rural_to_rural_tsweight_512x512.py',
...
name = 'SMDA_EMD_VIB_urban100rural_2rural_pseudo_lr5e-06_tsw0.8_Apr_20'

exp = 'trustweighted_vib'
