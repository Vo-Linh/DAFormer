...
_base_ = [
    ...
    '../_base_/datasets/smda_urban_20rural_to_rural_512x512.py',
...
checkpoint_config = dict(by_epoch=False, interval=2000, max_keep_ckpts=15)
evaluation = dict(interval=2000, metric='mIoU')
# Meta Information for Result Analysis
name = 'exp2_urban_100rural_2rural_smda_Feb22'
exp = 'basic'
