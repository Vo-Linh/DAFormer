...
class SMDACS(UDADecorator):
    ...
    def forward_train(self, img, img_metas, gt_semantic_seg, target_img,
        ...
        # target_img_with_labels = []
        # target_gt_semantic_seg_with_labels = []
        
        # for i in range(batch_size):
        #     if target_img_metas[i].get('with_labels', False):
        #         target_img_with_labels.append(target_img[i].clone())
        #         target_gt_semantic_seg_with_labels.append(
        #             target_gt_semantic_seg[i].clone())
                
        # if len(target_img_with_labels) > 0:
        #     # mmcv.print_log(
        #     #     f'Using {len(target_img_with_labels)} target images with labels',
        #     #     'mmseg')
        #     target_imgs_tensor = torch.stack(target_img_with_labels)
        #     target_segs_tensor = torch.stack(target_gt_semantic_seg_with_labels)
        ...
        #     clean_losses = add_prefix(clean_losses, 'target')
